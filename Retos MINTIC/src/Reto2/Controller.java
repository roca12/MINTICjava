...
import Reto2.Estudiante;
import Reto2.EstudianteVO;
import Reto2.VistaConsola;

public class Controller {
    
    private VistaConsola vista;
    private EstudianteVO instituto;
    
    public Controller(){
        vista = new VistaConsola();
        instituto = new EstudianteVO();
        funcionar();
    }
    ...
    public void ingresarEstudiante(){
        ...
        if(instituto.getEstudianteDAO().agregarEstudiante(n, a, fn, ci, cp, cel, f, pr, instituto.getEstudiantes())){
    ...
    public void modificarEstudiante(){
        ...
        if(rta != null){
            ...
            f = vista.leerDatoLong("Ingresar número fijo: ");
            pr = vista.leerDatoString("Ingresar programa: ");
            instituto.getEstudianteDAO().eliminarEstudiante(ci, instituto.getEstudiantes());
            instituto.getEstudianteDAO().agregarEstudiante(n, a, fn, ci, cp, cel, f, pr, instituto.getEstudiantes());
    ...
    public void eliminarEstudiante(){
        ...
        vista.mostrarInformacion("\nEliminar estudiante");
        ci = vista.leerDatoString("Ingresar correo institucional: ");
        if(instituto.getEstudianteDAO().eliminarEstudiante(ci, instituto.getEstudiantes())){
    ...
    public void mostrarDirectorio(){
        ...
        vista.mostrarInformacion(instituto.getEstudianteDAO().verEstudiantes(instituto.getEstudiantes()));
    }
}
