...
import com.roca12.learn.mintic.webservicesmintic.entities.Paises;
 ...
 */
@Stateless
@Path("com.roca12.learn.mintic.webservicesmintic.entities.paises")
public class PaisesFacadeREST extends AbstractFacade<Paises> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Paises entity) {
        super.edit(entity);
    }
