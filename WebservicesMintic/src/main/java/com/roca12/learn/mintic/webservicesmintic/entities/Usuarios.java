...
public class Usuarios implements Serializable {
    ...
    private Collection<AuditoriaAcceso> auditoriaAccesoCollection;
    ...
    public Collection<AuditoriaAcceso> getAuditoriaAccesoCollection() {
        return auditoriaAccesoCollection;
    }

    public void setAuditoriaAccesoCollection(Collection<AuditoriaAcceso> auditoriaAccesoCollection) {
        this.auditoriaAccesoCollection = auditoriaAccesoCollection;
    }
    ...
    public String toString() {
        return "com.roca12.learn.mintic.webservicesmintic.entities.Usuarios[ id=" + id + " ]";
    }
